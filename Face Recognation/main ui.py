...
class Face_Recognation_System:
    ...
    def __init__(self, root):
        ...
        # ==================== Background Image ====================
        img_bg = Image.open(r"C:\Users\Asus\OneDrive\Desktop\Acadamic\Final Project\Face Recognation\background.jpg")
        ...
        # ==================== Title Label ====================
        title_lbl = Label(bg_image, text="FACE RECOGNATION ATTENDENCE SYSTEM",
                          font=('times new roman', 40, "bold"), bg='white', fg='red')
        title_lbl.place(x=-130, y=0, width=1800, height=100)


        # ==================== Student Button ====================
        img_student = Image.open(r"C:\Users\Asus\OneDrive\Desktop\Acadamic\Final Project\Face Recognation\student.png")
        img_student = img_student.resize((300, 220), Image.LANCZOS)
        self.photoimg_student = ImageTk.PhotoImage(img_student)

        btn_student_img = Button(bg_image, image=self.photoimg_student, cursor='hand2')
        ...
        img_face = Image.open(r"C:\Users\Asus\OneDrive\Desktop\Acadamic\Final Project\Face Recognation\face_detect.png")
        ...
        # ==================== Attendance Button ====================
        img_attendance = Image.open(r"C:\Users\Asus\OneDrive\Desktop\Acadamic\Final Project\Face Recognation\attendance.png")
        ...
        # ==================== Help Desk Button ====================
        img_help = Image.open(r"C:\Users\Asus\OneDrive\Desktop\Acadamic\Final Project\Face Recognation\help.png")
        ...
        btn_help_text = Button(bg_image, text="Attendence", cursor='hand2',
                               font=('times new roman', 15, "bold"), bg='darkblue', fg='white')
        btn_help_text.place(x=1100, y=360, width=220, height=40)


        # ==================== Train Button ====================
        img_train = Image.open(r"C:\Users\Asus\OneDrive\Desktop\Acadamic\Final Project\Face Recognation\train.png")
        ...
        btn_train_text = Button(bg_image, text="Attendence", cursor='hand2',
                                font=('times new roman', 15, "bold"), bg='darkblue', fg='white')
        btn_train_text.place(x=200, y=670, width=220, height=40)


        # ==================== Photos Button ====================
        img_photos = Image.open(r"C:\Users\Asus\OneDrive\Desktop\Acadamic\Final Project\Face Recognation\photos.png")
        img_photos = img_photos.resize((250, 220), Image.LANCZOS)
        self.photoimg_photos = ImageTk.PhotoImage(img_photos)

        btn_photos_img = Button(bg_image, image=self.photoimg_photos, cursor='hand2')
        btn_photos_img.place(x=500, y=460, width=220, height=220)

        btn_photos_text = Button(bg_image, text="Attendence", cursor='hand2',
                                 font=('times new roman', 15, "bold"), bg='darkblue', fg='white')
        btn_photos_text.place(x=500, y=670, width=220, height=40)
        

        # ==================== Developer Button ====================
        img_dev = Image.open(r"C:\Users\Asus\OneDrive\Desktop\Acadamic\Final Project\Face Recognation\developer.png")
        ...
        # ==================== Exit Button ====================
        img_exit = Image.open(r"C:\Users\Asus\OneDrive\Desktop\Acadamic\Final Project\Face Recognation\exit.png")
